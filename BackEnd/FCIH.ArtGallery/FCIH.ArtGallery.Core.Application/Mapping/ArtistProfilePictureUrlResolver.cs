...
{
	internal class ArtistProfilePictureUrlResolver(IConfiguration configuration) : IValueResolver<Artist, ArtistProfileDto, string?>
	{
		public string? Resolve(Artist source, ArtistProfileDto destination, string? destMember, ResolutionContext context)
		{
